 ...
 * Description: Add a cart icon to the menu chosen
 * Version: 1.0
...
if ( class_exists( 'WooCommerce' ) ) {
	...
	function add_woo_cart( $items, $args ) {
		...
		global $woocommerce;
		ob_start(); ?>
		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="cartIcon"
		     x="0px" y="0px" width="15px" height="15px" viewBox="0 0 475.084 475.085"
		     style="enable-background:new 0 0 475.084 475.085;" xml:space="preserve">
			<g>
				<path
